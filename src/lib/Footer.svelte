  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    <div class="flex flex-col md:flex-row justify-between items-center">
      <div class="text-center md:text-left">
        <h4 class="text-lg font-semibold text-white mb-2">Our Mission</h4>
      ...
      <a href="https://github.com/fernandoleano" class="text-gray-400 hover:text-white mt-4 md:mt-0">
    ...
    <p class="text-center text-gray-400 mt-4">© 2023 Fernando Leano. All rights reserved.</p>
  </div>
</footer>